 ...
 * @param {{x: number, y: number}} imgElementTranslation new x/y position requested for the image
...
export function restrictPosition(
  imgElementTranslation,
  imageSize,
  cropSize,
  zoom) {
  const result = {
    x: restrictPositionCoord(imgElementTranslation.x, imageSize.width, cropSize.width, zoom),
    y: restrictPositionCoord(imgElementTranslation.y, imageSize.height, cropSize.height, zoom),
  }
  return result;
}
