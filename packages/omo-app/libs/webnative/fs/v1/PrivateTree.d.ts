...
export default class PrivateTree extends BaseTree {
    ...
    createOrUpdateChildFile(content: FileContent, name: string, onUpdate: Maybe<UpdateCallback>): Promise<PrivateFile>;
    ...
    get(path: string): Promise<PrivateTree | PrivateFile | null>;
    getRecurse(nodeInfo: PrivateSkeletonInfo, parts: string[]): Promise<Maybe<{
        key: string;
        node: DecryptedNode;
    }>>;
    getLinks(): BaseLinks;
