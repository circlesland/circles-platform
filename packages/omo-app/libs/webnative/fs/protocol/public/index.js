...
export var putTree = function (links, skeletonVal, metadataVal, previousCID) { return __awaiter(void 0, void 0, void 0, function () {
    var userlandInfo, userland, _a, metadata, skeleton, previous, _b, _c, _d, _e, internalLinks, _f, cid, size;
    return __generator(this, function (_g) {
        switch (_g.label) {
            case 0: return [4 /*yield*/, basic.putLinks(links)];
            case 1:
            ...
            case 2:
                ...
                return [4 /*yield*/, ipfs.size(previousCID)];
            case 3:
            ...
            case 5:
                ...
                return [4 /*yield*/, basic.putLinks(internalLinks)];
            case 6:
...
export var putFile = function (content, metadataVal, previousCID) { return __awaiter(void 0, void 0, void 0, function () {
    var userlandInfo, userland, metadata, previous, _a, _b, _c, _d, internalLinks, _e, cid, size;
    return __generator(this, function (_f) {
        switch (_f.label) {
            case 0: return [4 /*yield*/, basic.putFile(content)];
            case 1:
                userlandInfo = _f.sent();
                userland = link.make('userland', userlandInfo.cid, true, userlandInfo.size);
                return [4 /*yield*/, putAndMakeLink('metadata', metadataVal)];
            case 2:
                metadata = _f.sent();
                if (!(previousCID != null)) return [3 /*break*/, 4];
                _c = (_b = link).make;
...
export var putAndMakeLink = function (name, val) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, cid, size;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0: return [4 /*yield*/, ipfs.encoded.add(val, null)];
            case 1:
...
export var get = function (cid) { return __awaiter(void 0, void 0, void 0, function () {
    var links, metadata, skeleton, _a, userland, previous;
    var _b, _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0: return [4 /*yield*/, basic.getLinks(cid)];
            case 1:
                links = _d.sent();
                return [4 /*yield*/, getAndCheckValue(links, 'metadata', check.isMetadata)];
            case 2:
                metadata = _d.sent();
                if (!metadata.isFile) return [3 /*break*/, 3];
                _a = undefined;
                return [3 /*break*/, 5];
            case 3: return [4 /*yield*/, getAndCheckValue(links, 'skeleton', check.isSkeleton)];
            case 4:
                _a = _d.sent();
                _d.label = 5;
            case 5:
...
export var getValue = function (linksOrCID, name) { return __awaiter(void 0, void 0, void 0, function () {
    var links;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!isString(linksOrCID)) return [3 /*break*/, 2];
                return [4 /*yield*/, basic.getLinks(linksOrCID)];
            case 1:
                links = _a.sent();
                return [2 /*return*/, getValueFromLinks(links, name)];
            case 2: return [2 /*return*/, getValueFromLinks(linksOrCID, name)];
        }
    });
}); };
export var getValueFromLinks = function (links, name) { return __awaiter(void 0, void 0, void 0, function () {
    var linkCID;
    var _a;
    return __generator(this, function (_b) {
        ...
        return [2 /*return*/, ipfs.encoded.catAndDecode(linkCID, null)];
    });
}); };
export var getAndCheckValue = function (linksOrCid, name, checkFn, canBeNull) {
    if (canBeNull === void 0) { canBeNull = false; }
    return __awaiter(void 0, void 0, void 0, function () {
        var val;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getValue(linksOrCid, name)];
                case 1:
                    val = _a.sent();
