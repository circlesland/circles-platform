...
export const setTrustService = (context) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return yield context.environment.eth.contracts.hub.setTrust(safeState.myKey.privateKey, gnosisSafeProxy, context.data.trustReceiver.value, new BN(100));
});
