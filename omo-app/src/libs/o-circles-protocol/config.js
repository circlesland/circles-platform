...
export const config = {
    ganache: {
        ...
        getGasPrice: (web3) => new BN(web3.utils.toWei("1", "gwei")),
        ethjs: {
            getCommon: function (web3) {
    ...
    xDai: {
            ...
            getCommon: function (web3) {
                return __awaiter(this, void 0, void 0, function* () {
                    return Common.forCustomChain('mainnet', {
                        ...
                        chainId: yield web3.eth.getChainId(),
                    }, 'istanbul');
                });
            }
        },
        web3: () => {
            if (web3Instance)
                return web3Instance;
            const provider = new Web3.providers.WebsocketProvider("wss://xdai.poanetwork.dev/wss", {
                timeout: 30000,
                reconnect: {
                    auto: true,
                    delay: 5000,
