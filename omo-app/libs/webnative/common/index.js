...
export var READ_KEY_FROM_LOBBY_NAME = "filesystem-lobby";
export var UCANS_STORAGE_KEY = "webnative.auth_ucans";
export var USERNAME_STORAGE_KEY = "webnative.auth_username";
/**
