...
var PublicTree = /** @class */ (function (_super) {
    ...
    PublicTree.fromCID = function (cid) {
        return __awaiter(this, void 0, void 0, function () {
            var info;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, protocol.pub.get(cid)];
                    case 1:
                        info = _a.sent();
                        if (!check.isTreeInfo(info)) {
                            throw new Error("Could not parse a valid public tree at: " + cid);
                        }
                        return [2 /*return*/, PublicTree.fromInfo(info, cid)];
                }
            });
        });
    };
    PublicTree.fromInfo = function (info, cid) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, protocol.basic.getLinks(userland)];
                    case 1:
                        links = _a.sent();
                        return [2 /*return*/, new PublicTree({
                                links: links,
    ...
    PublicTree.prototype.createChildTree = function (name, onUpdate) {
        return __awaiter(this, void 0, void 0, function () {
            var child, existing;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    PublicTree.prototype.createOrUpdateChildFile = function (content, name, onUpdate) {
        return __awaiter(this, void 0, void 0, function () {
            var existing, file;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 6: return [4 /*yield*/, this.updateDirectChild(file, name, onUpdate)];
                    case 7:
                        _a.sent();
    ...
    PublicTree.prototype.putDetailed = function () {
        return __awaiter(this, void 0, void 0, function () {
            var details;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, protocol.pub.putTree(this.links, this.header.skeleton, this.header.metadata, this.cid)];
                    case 1:
                        details = _a.sent();
    ...
    PublicTree.prototype.updateDirectChild = function (child, name, onUpdate) {
        return __awaiter(this, void 0, void 0, function () {
            var details, _a;
    ...
    PublicTree.prototype.getDirectChild = function (name) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, PublicFile.fromCID(childInfo.cid)];
                    case 1:
                        _a = _b.sent();
                        return [3 /*break*/, 4];
                    case 2: return [4 /*yield*/, PublicTree.fromCID(childInfo.cid)
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        if (skeletonInfo === null)
                            return [2 /*return*/, null];
                        return [4 /*yield*/, protocol.pub.get(skeletonInfo.cid)];
                    case 1:
                        info = _a.sent();
