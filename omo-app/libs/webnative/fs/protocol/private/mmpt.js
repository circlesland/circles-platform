...
var MMPT = /** @class */ (function () {
    ...
    MMPT.fromCID = function (cid) {
        return __awaiter(this, void 0, void 0, function () {
            var links;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, basic.getSimpleLinks(cid)];
                    case 1:
                        links = _a.sent();
    ...
    MMPT.prototype.putDetailed = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, basic.putLinks(this.links)];
            });
        });
    };
    MMPT.prototype.put = function () {
        return __awaiter(this, void 0, void 0, function () {
            var cid;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    MMPT.prototype.add = function (name, value) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.getDirectChild(nextNameOrSib)];
                    case 3:
                        nextTree = _a.sent();
    ...
    MMPT.prototype.get = function (name) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.getDirectChild(nextName)];
                    case 1:
                        nextTree = _a.sent();
                        return [2 /*return*/, nextTree.get(name.slice(1))];
                }
            });
        });
    };
    MMPT.prototype.exists = function (name) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    MMPT.prototype.members = function () {
        return __awaiter(this, void 0, void 0, function () {
            var children;
            var _this = this;
            return __generator(this, function (_a) {
                                ...
                                return __generator(this, function (_b) {
                                    switch (_b.label) {
                                        case 0:
                                            ...
                                            return [4 /*yield*/, MMPT.fromCID(cid)];
                                        case 1:
                                            child = _b.sent();
                                            return [4 /*yield*/, child.members()];
                                        case 2:
    ...
    MMPT.prototype.getDirectChild = function (name) {
        return __awaiter(this, void 0, void 0, function () {
            var child;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, MMPT.fromCID(this.links[name].cid)
