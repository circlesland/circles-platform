...
export var addNode = function (mmpt, node, key) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, cid, size, filter, name, contentBareFilter, contentFilter, contentName, _b, skeleton, isFile;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0: return [4 /*yield*/, basic.putEncryptedFile(node, key)];
            case 1:
            ...
            case 3:
                name = _c.sent();
                return [4 /*yield*/, mmpt.add(name, cid)
            ...
            case 7:
                contentName = _c.sent();
                return [4 /*yield*/, mmpt.add(contentName, node.content)];
            case 8:
                _c.sent();
                _c.label = 9;
            case 9:
...
export var readNode = function (cid, key) { return __awaiter(void 0, void 0, void 0, function () {
    var content;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, ipfs.encoded.catAndDecode(cid, key)];
            case 1:
                content = _a.sent();
...
export var getByName = function (mmpt, name, key) { return __awaiter(void 0, void 0, void 0, function () {
    var cid;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, mmpt.get(name)];
            case 1:
                cid = _a.sent();
                if (cid === null)
                    return [2 /*return*/, null];
                return [2 /*return*/, getByCID(cid, key)];
        }
    });
}); };
export var getByCID = function (cid, key) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, readNode(cid, key)];
            case 1: return [2 /*return*/, _a.sent()];
        }
    });
}); };
export var getByLatestName = function (mmpt, name, key) { return __awaiter(void 0, void 0, void 0, function () {
    var cid;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, mmpt.get(name)];
            case 1:
                ...
                if (cid === null)
                    return [2 /*return*/, null];
                return [2 /*return*/, getLatestByCID(mmpt, cid, key)];
        }
    });
}); };
export var getLatestByCID = function (mmpt, cid, key) { return __awaiter(void 0, void 0, void 0, function () {
    var node, latest, _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0: return [4 /*yield*/, getByCID(cid, key)];
            case 1:
                node = _b.sent();
                return [4 /*yield*/, findLatestRevision(mmpt, node.bareNameFilter, key, node.revision)];
            case 2:
                latest = _b.sent();
                if (!(latest === null || latest === void 0 ? void 0 : latest.cid)) return [3 /*break*/, 4];
                return [4 /*yield*/, getByCID(latest === null || latest === void 0 ? void 0 : latest.cid, key)];
            case 3:
                _a = _b.sent();
                return [3 /*break*/, 5];
            case 4:
...
export var findLatestRevision = function (mmpt, bareName, key, lastKnownRevision) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, getRevision(mmpt, bareName, key, toCheck)];
            case 2:
            ...
            case 3:
                ...
                return [4 /*yield*/, getRevision(mmpt, bareName, key, midpoint)];
            case 4:
                thisRevision = _a.sent();
                if (thisRevision !== null) {
                    lastRevision = thisRevision;
...
export var getRevision = function (mmpt, bareName, key, revision) { return __awaiter(void 0, void 0, void 0, function () {
    var filter, name, cid;
    return __generator(this, function (_a) {
        switch (_a.label) {
