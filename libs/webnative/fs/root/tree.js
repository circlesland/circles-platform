...
var RootTree = /** @class */ (function () {
    ...
    // INITIALISATION
    // --------------
    RootTree.empty = function (_a, timeout) {
        var key = _a.key;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        privateTree = _b.sent();
                        return [4 /*yield*/, privateTree.put(timeout)
                            // Construct tree
                        ];
                    case 4:
                        _b.sent();
                        ...
                        tree.setVersion(semver.v1, timeout);
                        return [4 /*yield*/, Promise.all([
                                tree.updatePuttable(Branch.Public, publicTree, timeout),
                                tree.updatePuttable(Branch.Pretty, prettyTree, timeout),
                                tree.updatePuttable(Branch.Private, mmpt, timeout)
                            ])
                            // Fin
                        ];
                    case 5:
    ...
    RootTree.fromCID = function (_a, timeout) {
        var _b, _c, _d;
            ...
            return __generator(this, function (_h) {
                switch (_h.label) {
                    ...
                    case 2:
                        _e = _h.sent();
                        return [3 /*break*/, 5];
                    case 3: return [4 /*yield*/, PublicTree.fromCID(publicCID, timeout)];
                    case 4:
                        _e = _h.sent();
                        _h.label = 5;
                    case 5:
                        ...
                        return [4 /*yield*/, BareTree.fromCID(links[Branch.Pretty].cid, timeout)];
                    case 6:
                        _f = _h.sent();
                        return [3 /*break*/, 9];
                    ...
                    case 11:
                        privateTree = _h.sent();
                        return [3 /*break*/, 15];
                    case 12: return [4 /*yield*/, MMPT.fromCID(privateCID, timeout)];
                    case 13:
                        mmpt = _h.sent();
                    ...
                    case 15:
                        ...
                        return [4 /*yield*/, ipfs.dagGet(privateLogCid, timeout)
    ...
    // MUTATIONS
    // ---------
    RootTree.prototype.put = function (timeout) {
        return __awaiter(this, void 0, void 0, function () {
            var cid;
    ...
    RootTree.prototype.putDetailed = function (timeout) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    RootTree.prototype.updatePuttable = function (name, puttable, timeout) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _a = this.updateLink;
                        _b = [name];
                        return [4 /*yield*/, puttable.putDetailed(timeout)];
                    case 1: return [2 /*return*/, _a.apply(this, _b.concat([_c.sent()]))];
                }
            });
        });
    };
    RootTree.prototype.addPrivateLogEntry = function (cid, timeout) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, ipfs.cat(log[idx].cid, null)];
                    case 1:
                        _b = (_f.sent()).split(",");
                        return [3 /*break*/, 3];
                    case 2:
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, protocol.basic.putFile(updatedChunk.join(","), timeout)];
                    case 5:
                        ...
                        return [4 /*yield*/, ipfs.dagPutLinks(log.map(link.toDAGLink), timeout)];
                    case 6:
                        logDeposit = _f.sent();
                        _c = this.updateLink;
                        ...
                        return [4 /*yield*/, ipfs.size(logDeposit.cid, timeout)];
                    case 7:
    ...
    // VERSION
    // -------
    RootTree.prototype.setVersion = function (version, timeout) {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, protocol.basic.putFile(semver.toString(version), timeout)];
                    case 1:
                        result = _a.sent();
