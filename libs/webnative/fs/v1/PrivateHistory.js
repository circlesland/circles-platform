...
var PrivateHistory = /** @class */ (function () {
     ...
     */
    PrivateHistory.prototype.back = function (delta, timeout) {
        var _a;
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this._getRevision(revision + n, timeout)];
                    case 1:
                        _b = (_c.sent());
                        _c.label = 2;
     ...
     */
    PrivateHistory.prototype.prior = function (timestamp, timeout) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (this.node.header.metadata.unixMeta.mtime < timestamp) {
                    ...
                    return [2 /*return*/, this._prior(this.node.header.revision - 1, timestamp, timeout)];
                }
                return [2 /*return*/];
            });
        });
     ...
     */
    PrivateHistory.prototype.list = function (amount, timeout) {
        return __awaiter(this, void 0, void 0, function () {
            var max;
            var _this = this;
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, Promise.all(Array.from({ length: amount }, function (_, i) {
                        var n = i + 1;
                        return _this._getRevisionInfoFromNumber(max - n, timeout).then(function (info) { return ({
                            revisionInfo: info,
                            delta: -n
                        }); });
     ...
     * @internal
     */
    PrivateHistory.prototype._getRevision = function (revision, timeout) {
        return __awaiter(this, void 0, void 0, function () {
            var info, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this._getRevisionInfoFromNumber(revision, timeout)];
                    case 1:
                        info = _b.sent();
                        _a = info;
    ...
    PrivateHistory.prototype._getRevisionInfo = function (revision) {
        return protocol.priv.readNode(revision.cid, this.node.key, null);
    };
    /**
     * @internal
     */
    PrivateHistory.prototype._getRevisionInfoFromNumber = function (revision, timeout) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, protocol.priv.getRevision(mmpt, bareNameFilter, key, revision, timeout)];
                    case 1:
                        r = _b.sent();
     ...
     * @internal
     */
    PrivateHistory.prototype._prior = function (revision, timestamp, timeout) {
        return __awaiter(this, void 0, void 0, function () {
            var info;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (info.metadata.unixMeta.mtime < timestamp) {
                            return [2 /*return*/, this._getRevision(info.revision, timeout)];
                        }
                        else {
                            return [2 /*return*/, this._prior(info.revision - 1, timestamp, timeout)];
                        }
                        return [2 /*return*/];
                }
            });
