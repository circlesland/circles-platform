...
var PrivateFile = /** @class */ (function (_super) {
    ...
    PrivateFile.create = function (mmpt, content, parentNameFilter, key, timeout) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        contentKey = _a.sent();
                        return [4 /*yield*/, protocol.basic.putEncryptedFile(content, contentKey, timeout)];
                    case 3:
                        contentInfo = _a.sent();
    ...
    PrivateFile.fromName = function (mmpt, name, key, timeout) {
        return __awaiter(this, void 0, void 0, function () {
            var info;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, PrivateFile.fromInfo(mmpt, key, info, timeout)];
                }
            });
        });
    };
    PrivateFile.fromInfo = function (mmpt, key, info, timeout) {
        return __awaiter(this, void 0, void 0, function () {
            var content;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, protocol.basic.getEncryptedFile(info.content, info.key, timeout)];
                    case 1:
                        content = _a.sent();
                        return [2 /*return*/, new PrivateFile({
                                content: content,
    ...
    PrivateFile.prototype.updateContent = function (content, timeout) {
        return __awaiter(this, void 0, void 0, function () {
            var contentInfo;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, protocol.basic.putEncryptedFile(content, this.header.key, timeout)];
                    case 1:
                        contentInfo = _a.sent();
    ...
    PrivateFile.prototype.putDetailed = function (timeout) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, protocol.priv.addNode(this.mmpt, __assign(__assign({}, this.header), { metadata: metadata.updateMtime(this.header.metadata) }), this.key, timeout)];
            });
        });
    };
    return PrivateFile;
