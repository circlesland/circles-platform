...
var PrivateTree = /** @class */ (function (_super) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        name = _a.sent();
                        return [4 /*yield*/, protocol.priv.getByLatestName(mmpt, name, key, null)];
                    case 4:
                        info = _a.sent();
    ...
    PrivateTree.fromName = function (mmpt, name, key) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, protocol.priv.getByName(mmpt, name, key, null)];
                    case 1:
                        info = _a.sent();
                        if (!check.isPrivateTreeInfo(info)) {
                            throw new Error("Could not parse a valid private tree using the given key");
    ...
    PrivateTree.prototype.createChildTree = function (name, onUpdate, timeout) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    PrivateTree.prototype.createOrUpdateChildFile = function (content, name, onUpdate, timeout) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        key = _a.sent();
                        return [4 /*yield*/, PrivateFile.create(this.mmpt, content, this.header.bareNameFilter, key, timeout)];
                    case 3:
                        file = _a.sent();
                        return [3 /*break*/, 7];
                    case 4:
                    ...
                    case 7: return [4 /*yield*/, this.updateDirectChild(file, name, onUpdate, timeout)];
                    case 8:
                        _a.sent();
    ...
    PrivateTree.prototype.putDetailed = function (timeout) {
        return __awaiter(this, void 0, void 0, function () {
            var nodeCopy;
            return __generator(this, function (_a) {
                nodeCopy = Object.assign({}, this.header);
                return [2 /*return*/, protocol.priv.addNode(this.mmpt, nodeCopy, this.key, timeout)];
            });
        });
    };
    PrivateTree.prototype.updateDirectChild = function (child, name, onUpdate, timeout) {
        return __awaiter(this, void 0, void 0, function () {
            var details, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
    ...
    PrivateTree.prototype.getDirectChild = function (name, timeout) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, PrivateFile.fromName(this.mmpt, childInfo.pointer, childInfo.key, timeout)];
                    case 1:
                        _a = _b.sent();
                        return [3 /*break*/, 4];
    ...
    PrivateTree.prototype.get = function (path, timeout) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (next === undefined)
                            return [2 /*return*/, null];
                        return [4 /*yield*/, this.getRecurse(next, rest, null)];
                    case 1:
                        result = _a.sent();
                        if (result === null)
                            return [2 /*return*/, null];
                        return [2 /*return*/, check.isPrivateFileInfo(result.node)
                                ? PrivateFile.fromInfo(this.mmpt, result.key, result.node, timeout)
                                : PrivateTree.fromInfo(this.mmpt, result.key, result.node)];
                }
            });
        });
    };
    PrivateTree.prototype.getRecurse = function (nodeInfo, parts, timeout) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, protocol.priv.getByCID(nodeInfo.cid, nodeInfo.key, timeout)];
                    case 1: return [2 /*return*/, (_a.node = _b.sent(),
                            _a)];
                    case 2:
                        nextChild = nodeInfo.subSkeleton[head];
                        if (nextChild !== undefined) {
                            return [2 /*return*/, this.getRecurse(nextChild, rest, timeout)];
                        }
                        return [4 /*yield*/, protocol.priv.getByCID(nodeInfo.cid, nodeInfo.key, timeout)];
                    case 3:
                        ...
                        return [2 /*return*/, reloadedNext === undefined ? null : this.getRecurse(reloadedNext, rest, timeout)];
                }
            });
        });
    };
