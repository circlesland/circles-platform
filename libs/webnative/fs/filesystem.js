...
var FileSystem = /** @class */ (function () {
     ...
     */
    FileSystem.empty = function (opts, timeout) {
        if (opts === void 0) { opts = {}; }
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        key = _b.sent();
                        return [4 /*yield*/, RootTree.empty({ key: key }, timeout)];
                    case 2:
                        root = _b.sent();
                        fs = new FileSystem({
                            root: root,
     ...
     */
    FileSystem.fromCID = function (cid, opts, timeout) {
        if (opts === void 0) { opts = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var _a, keyName, permissions, localOnly, key, root, fs;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        key = _b.sent();
                        return [4 /*yield*/, RootTree.fromCID({ cid: cid, key: key }, timeout)];
                    case 2:
                        root = _b.sent();
                        fs = new FileSystem({
                            root: root,
    ...
    // POSIX INTERFACE
    // ---------------
    FileSystem.prototype.mkdir = function (path, options, timeout) {
        return __awaiter(this, void 0, void 0, function () {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.runOnTree(path, true, function (tree, relPath) {
                                return tree.mkdir(relPath, null, timeout);
                            }, timeout)];
                    case 1:
                        _a.sent();
                        if (!options.publish) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.publish(timeout)];
                    case 2:
                        _a.sent();
                        _a.label = 3;
    ...
    FileSystem.prototype.ls = function (path, timeout) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.runOnTree(path, false, function (tree, relPath) {
                        return tree.ls(relPath, timeout);
                    }, timeout)];
            });
        });
    };
    FileSystem.prototype.add = function (path, content, options, timeout) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        options = options === null ? {} : options;
                        return [4 /*yield*/, this.runOnTree(path, true, function (tree, relPath) {
                                return tree.add(relPath, content, timeout);
                            }, timeout)];
                    case 1:
                        _a.sent();
                        if (!options.publish) return [3 /*break*/, 3];
    ...
    FileSystem.prototype.cat = function (path, timeout) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.runOnTree(path, false, function (tree, relPath) {
                        return tree.cat(relPath, timeout);
                    }, timeout)];
            });
        });
    };
    FileSystem.prototype.exists = function (path, timeout) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.runOnTree(path, false, function (tree, relPath) {
                        return tree.exists(relPath, timeout);
                    }, timeout)];
            });
        });
    };
    FileSystem.prototype.rm = function (path, timeout) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.runOnTree(path, true, function (tree, relPath) {
                            return tree.rm(relPath, timeout);
                        }, timeout)];
                    case 1:
                        _a.sent();
    ...
    FileSystem.prototype.get = function (path, timeout) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.runOnTree(path, false, function (tree, relPath) {
                        return tree.get(relPath, timeout);
                    }, timeout)];
            });
        });
    };
    // This is only implemented on the same tree for now and will error otherwise
    FileSystem.prototype.mv = function (from, to, timeout) {
        return __awaiter(this, void 0, void 0, function () {
            var sameTree;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.runOnTree(from, true, function (tree, relPath) {
                                ...
                                return tree.mv(relPath, nextPath || '', timeout);
                            }, timeout)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/, this];
    ...
    FileSystem.prototype.read = function (path) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.cat(path, null)];
            });
        });
    };
    FileSystem.prototype.write = function (path, content, options, timeout) {
        if (options === void 0) { options = {}; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.add(path, content, options, timeout)];
            });
        });
    };
    // PUBLISH
     ...
     */
    FileSystem.prototype.publish = function (timeout) {
        return __awaiter(this, void 0, void 0, function () {
            var proofs, cid;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        this.proofs = {};
                        return [4 /*yield*/, this.root.put(timeout)];
                    case 1:
                        cid = _a.sent();
    ...
    // --------
    /** @internal */
    FileSystem.prototype.runOnTree = function (path, isMutation, fn, timeout) {
        return __awaiter(this, void 0, void 0, function () {
                ...
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, Promise.all([
                                this.root.updatePuttable(Branch.Public, this.root.publicTree, timeout),
                                this.root.updatePuttable(Branch.Pretty, this.root.prettyTree, timeout)
                            ])];
                    case 5:
                        _a.sent();
                        _a.label = 6;
                    ...
                    case 8:
                        ...
                        return [4 /*yield*/, this.root.privateTree.put(timeout)];
                    case 9:
                        cid = _a.sent();
                        return [4 /*yield*/, this.root.updatePuttable(Branch.Private, this.root.mmpt, timeout)];
                    case 10:
                        _a.sent();
                        return [4 /*yield*/, this.root.addPrivateLogEntry(cid, timeout)];
                    case 11:
                        _a.sent();
                        _a.label = 12;
