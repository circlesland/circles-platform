...
import { defaultTimeout } from "./logFormatted";
/**
        ...
        return __generator(this, function (_f) {
            switch (_f.label) {
                ...
                case 18:
                    ...
                    return [4 /*yield*/, FileSystem.fromCID(cid, { keyName: keyName, permissions: p }, defaultTimeout)];
                case 19:
                    _e = _f.sent();
                    return [3 /*break*/, 21];
                case 20:
                ...
                case 21:
                    ...
                    return [4 /*yield*/, FileSystem.empty({ keyName: keyName, permissions: p }, defaultTimeout)];
                case 22:
                    // Otherwise make a new one
                    fs = _f.sent();
...
function addSampleData(fs) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fs.mkdir("private/Apps", null, defaultTimeout)];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, fs.mkdir("private/Audio", null, defaultTimeout)];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, fs.mkdir("private/Documents", null, defaultTimeout)];
                case 3:
                    _a.sent();
                    return [4 /*yield*/, fs.mkdir("private/Photos", null, defaultTimeout)];
                case 4:
                    _a.sent();
                    return [4 /*yield*/, fs.mkdir("private/Video", null, defaultTimeout)];
                case 5:
                    _a.sent();
                    return [4 /*yield*/, fs.publish(defaultTimeout)];
                case 6:
                    _a.sent();
                    return [2 /*return*/];
            }
