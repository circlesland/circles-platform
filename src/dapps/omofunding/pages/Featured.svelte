...
<section class="overflow-y-scroll bg-white text-light-500">
  <div
    class="flex flex-wrap mx-auto bg-white border md:my-20 rounded-xl border-light-200 lg:max-w-6xl">
    <img
      alt="pflanzenstoff"
      class="object-cover object-center w-full rounded h-96 lg:w-1/2 lg:h-auto"
      src="images/market/pflanzenstoff.jpg" />
    <div class="w-full p-6 md:p-16 lg:w-1/2">
      ...
      <div class="leading-relaxed text-light-500">
        <span class="text-xl font-bold text-light-500 font-primary">
        ...
        <p class="pt-2">
          ...
          with just 2.5g sugar. It tastes lively and refreshing with its natural
          only superfood incredients; Acerola, Aronia, Assai, Blackberries,
          Curcumin, Gojibeeren, Pomoegranate, Green Tea, Ginger, Carot,
          Mangosteen, Oranges, Beetroot and Grapes.
        </p>
      </div>
