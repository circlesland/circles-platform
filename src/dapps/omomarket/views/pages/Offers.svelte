    ...
    <!-- <div
      ...
      <div class="p-4 -mt-6 md:-mt-8">
        <span
          ...
          <img src="images/logo/crc-dark.svg" alt="CRC" class="w-6 h-6 mt-2" />
        </span>
        ...
        <div class="pt-4">
          <span class="font-sans text-xs font-medium text-light-500 md:text-sm">
            {item.data.city},
            {item.data.country}
      ...
      <div class="flex p-4 border-t text-light-500 ">
        <div>
          <img
            src={item.data.offeredBy.image}
            alt="user"
