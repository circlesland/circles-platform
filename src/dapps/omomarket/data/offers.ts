...
export let featured = [
  {
    data: {
      ...
      description:
        "The Great White Chuck is a white wine from us, Patrick and Chuck. We have discovered over the last year our passion for wines and want to share our taste with you now. Join our journey, as we continue to source the best breeds for you, always perfectly balancing quality and price.",
      price: "80",
      state: "pre-order",
      quantity: "1 bottle",
  ...
  },
  {
    data: {
      ...
      description:
        "Pflanzenstoff's vegan superfruits can support your concentration, stamina and your mental and bodily health. It tastes lively and refreshing with its natural only superfood incredients; Acerola, Aronia, Assai, Blackberries, Curcumin, Gojibeeren, Pomoegranate, Green Tea, Ginger, Carot, Mangosteen, Oranges, Beetroot and Grapes.",
      price: "100",
      state: "pre-order",
      quantity: "6 pack",
      delivery: "April 2021",
...
export let offers = [
  {
    data: {
      ...
      description:
        "Brand new UNU electro scooter delivered straight from the factory to your home. I pre-ordered this unique beauty this summer and according to UNU will be ready for shipping around spring 2021. In the package is a 4000 watt black scooter with 2 batteries and 1 helmet.",
      price: "100.000",
      state: "active",
      category: "mobility",
      // quantity: "",
  ...
  },
  {
    data: {
      ...
      description:
        "I am selling my 2 year old used macbook pro in very good condition, with slightly used marks. 256GB SSD, 8GB RAM, 2,3 GHz Quad-Core i5",
      price: "25.000",
      state: "active",
      category: "tech",
      // quantity: "",
