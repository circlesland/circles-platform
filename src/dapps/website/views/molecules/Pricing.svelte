<div
  ...
  <div
    ...
    <h2
      class="my-5 text-base font-medium tracking-tight text-indigo-500 uppercase">
      Our Pricing
    </h2>
    <h3
          ...
          <div
            ...
            <div
              ...
              <h3
                ...
                Basic<span class="ml-2 font-light">Plan</span>
              </h3>
              <h4
            ...
            <div class="flex flex-wrap px-6 mt-8">
              <ul>
                ...
                <li class="flex items-center">
                  ...
                  <span class="ml-3 text-lg text-gray-700">And Another Cool
                    Feature</span>
                </li>
                <li class="flex items-center">
                  <div class="p-2 text-green-500 rounded-full fill-current ">
        ...
        <div
          ...
          <div
            ...
            <h3
              ...
              Pro<span class="ml-2 font-light">Plan</span>
            </h3>
            <h4
        ...
        <div
          ...
          <div
            ...
            <div
              ...
              <h3
                class="p-3 pb-1 text-lg font-bold tracking-wide text-center uppercase">
                Premium<span class="ml-2 font-light">Plan</span>
              </h3>
              <h4
                class="flex items-center justify-center pb-6 text-4xl font-bold text-center text-gray-900">
            ...
            <div class="flex flex-wrap px-8 mt-8">
              <ul>
                <li class="flex items-center">
                  ...
                  <span class="ml-3 text-lg text-gray-700">Totally Tubular
                    Feature</span>
                </li>
                <li class="flex items-center">
                  <div class="p-2 text-green-500 rounded-full fill-current ">
