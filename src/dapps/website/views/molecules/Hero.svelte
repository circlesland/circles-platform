...
<div
  ...
  <div
    ...
    <div
      ...
      <h1
        class="relative mb-1 text-3xl font-black tracking-wider font-title text-secondary sm:text-4xl lg:text-5xl xl:mb-8">
        Own your money
      </h1>
      <h2
        class="relative mb-4 text-3xl font-black tracking-wider font-title text-secondary sm:text-4xl lg:text-5xl xl:mb-8">
        own your life!
      </h2>
      <p
      ...
      <!-- <div
        ...
        class="z-50 mb-20 cursor-pointer w-60">
        <Button
          mapping={{ data: { label: 'start growing now' }, design: { type: 'primary' } }} />
      </div> -->
    ...
    <div
      class="relative z-50 flex-col items-end justify-center hidden w-full h-full mt-24 md:flex md:m-0 lg:w-1/2 ms:pl-10">
      <div
