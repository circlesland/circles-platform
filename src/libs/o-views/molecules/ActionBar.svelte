...
{:else if safeAddress}
  <Compose
    ...
    tw="bg-white border-t border-light-200 text-light-400 h-20 justify-center items-center px-2 md:mb-4 mt-1 md:px-0 md:border md:border-light-200 md:rounded-xl">
