...
>
  <div class="flex items-center justify-center pl-6 mx-auto text-6xl uppercase">
    {parseFloat(web3.utils.fromWei(balance)).toFixed(2)}
    <span><img src="symbols/crc.svg" class="h-8 pb-2 pl-2" alt="CRC" /></span>
  </div>
</div>
